...
public class UIAutoAnimation : MonoBehaviour
{
    ...
    private bool IsAnimating()
    {
        ...
        return IsInvoking("EntranceAlphaEnumeration") ||
               IsInvoking("EntrancePositionEnumeration") ||
               IsInvoking("EntranceScaleEnumeration") ||
               IsInvoking("EntranceRotationEnumeration");
    }
}
